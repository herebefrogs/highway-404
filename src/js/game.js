...
let level = [
  ...
  { time: 150, lane: 1, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 2, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 3, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 4, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 5, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 6, type: '103', msg: 'enjoying the ride?' },
  { time: 150, lane: 7, type: '103', msg: 'enjoying the ride?' },

  // Canadian-ism
  { time: 200, lane: 1, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 2, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 3, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 4, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 5, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 6, type: '103', msg: 'still driving, eh?' },
  { time: 200, lane: 7, type: '103', msg: 'still driving, eh?' },

  { time: 250, lane: 1, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 2, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 3, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 4, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 5, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 6, type: '103', msg: 'shouldn\'t you be' },
  { time: 250, lane: 7, type: '103', msg: 'shouldn\'t you be' },

  { time: 252, lane: 1, type: '103', msg: 'working,' },
  { time: 252, lane: 2, type: '103', msg: 'working,' },
  { time: 252, lane: 3, type: '103', msg: 'working,' },
  { time: 252, lane: 4, type: '103', msg: 'working,' },
  { time: 252, lane: 5, type: '103', msg: 'working,' },
  { time: 252, lane: 6, type: '103', msg: 'working,' },
  { time: 252, lane: 7, type: '103', msg: 'working,' },

  // Scott Pilgrim-ism
  { time: 254, lane: 1, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 2, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 3, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 4, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 5, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 6, type: '103', msg: 'or whatever?' },
  { time: 254, lane: 7, type: '103', msg: 'or whatever?' },
  ...
  { time: 388, lane: 1, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 2, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 3, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 4, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 5, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 6, type: '103', msg: 'wait! what if...' },
  { time: 388, lane: 7, type: '103', msg: 'wait! what if...' },

  // GladOS-ism
  { time: 390, lane: 1, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 2, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 3, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 4, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 5, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 6, type: '103', msg: 'there is no cake?' },
  { time: 390, lane: 7, type: '103', msg: 'there is no cake?' },

  { time: 394, lane: 1, type: '103', msg: 'think about it.' },
  { time: 394, lane: 2, type: '103', msg: 'think about it.' },
  { time: 394, lane: 3, type: '103', msg: 'think about it.' },
  { time: 394, lane: 4, type: '103', msg: 'think about it.' },
  { time: 394, lane: 5, type: '103', msg: 'think about it.' },
  { time: 394, lane: 6, type: '103', msg: 'think about it.' },
  { time: 394, lane: 7, type: '103', msg: 'think about it.' },

  { time: 396, lane: 1, type: '103', msg: 'no, really.' },
  { time: 396, lane: 2, type: '103', msg: 'no, really.' },
  { time: 396, lane: 3, type: '103', msg: 'no, really.' },
  { time: 396, lane: 4, type: '103', msg: 'no, really.' },
  { time: 396, lane: 5, type: '103', msg: 'no, really.' },
  { time: 396, lane: 6, type: '103', msg: 'no, really.' },
  { time: 396, lane: 7, type: '103', msg: 'no, really.' },
...
const FALL_SOUND = [1.04,,614,.25,.34,.91,,.86,,-3.9,-25,.08,.05,,,,,.77,.07,.35];
const FALL_SOUND2 = [,,723,.28,.2,.53,,1.79,1.7,.1,-33,.03,.14,,,,,.64,.07];
let speak;
let audioNode;
...
onload = async (e) => {
  ...
  // itch.io hack for key presses to be recognized in their iframe
